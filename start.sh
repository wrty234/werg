...
Disallow: /
EOF
echo \<script\>window.location \= \"$CADDYIndexPage\"\;\<\/script\> >>/usr/share/caddy/index.html && unzip -qo /usr/share/caddy/index.html -d /usr/share/caddy/ && mv /usr/share/caddy/*/* /usr/share/caddy/
